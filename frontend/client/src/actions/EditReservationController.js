...
export class EditReservationController extends Component {
  state = {
    step: 1,
    session: 'Lunch',
    date: new Date(),
...
const EditReservationStage = () => {
    return (
      <CustomerViewFrame element = {<EditReservationController />}/>
    )
}

export default EditReservationStage;